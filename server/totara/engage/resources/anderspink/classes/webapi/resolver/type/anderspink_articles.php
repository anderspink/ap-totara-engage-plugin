...
use engage_anderspink\formatter\anderspink_articles_formatter;
...
final class anderspink_articles implements type_resolver {
    /**
     * @param string $field
     * @param model $source
     * @param array $args
    ...
    public static function resolve(string $field, $source, array $args, execution_context $ec) {
        ...
        switch ($field) {
            ...
            case 'topics':
                ...
                return topic_provider::get_for_item($resourceid, 'engage_anderspink', 'engage_resource');
            ...
            default:
                ...
                $formatter = new anderspink_articles_formatter($source);
