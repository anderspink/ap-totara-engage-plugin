...
$PAGE->set_title(get_string('anderspink_briefings', 'container_anderspink'));
$PAGE->set_pagelayout('legacynolayout');
$PAGE->set_url(new moodle_url('/container/type/anderspink/briefings.php'));
$PAGE->set_totara_menu_selected(anderspinkworkspace::class);

$component = new component('anderspink/pages/AnderspinkWorkspaceBriefingsSettings');
