...
namespace container_anderspink\share;
...
final class manager
{
    ...
    private static function create(
        ...
        $share_entity = manager::create_share($itemid, $ownerid, $component, $contextid);
        $shares       = [];

        foreach ($recipients as $recipient) {
            $recipient_entity = manager::create_recipient($share_entity->id, $sharerid, $recipient);
    ...
    public static function unshare(int $recipient_id, shareable $instance): void
    {
        ...
        if ($recipient->area !== user::AREA) {
            $library        = \totara_engage\share\recipient\helper::get_recipient_class($recipient->component,
                $recipient->area);
    ...
    /**
     * Simple share creation without making any additional adhoc tasks.
     *
     * @param shareable $instance
     * @param string $component
     ...
     * @throws coding_exception
     */
    public static function share_manually(
        shareable $instance,
        string $component,
        array $recipients,
        ?int $actor_id = null
        ...
        // Create shares for this resource.
        self::create($instance->get_id(), $instance->get_userid(), $component, $recipients, $context->id, $actor_id);
    }
}